...
public class HmMenuSubmenuSqlProvider {

    /**
     * This method was generated by MyBatis Generator.
     * This method corresponds to the database table hm_menu_submenu
     * @param record  Model for table hm_menu_submenu
     * @return   The combine SQL for table hm_menu_submenu
     *
     * @mbggenerated Mon Sep 18 10:55:56 CST 2017
     */
    public String insertSelective(HmMenuSubmenu record) {
        BEGIN();
        INSERT_INTO("hm_menu_submenu");
     ...
     * @mbggenerated Mon Sep 18 10:55:56 CST 2017
     */
    public String updateByPrimaryKeySelective(HmMenuSubmenu record) {
        BEGIN();
